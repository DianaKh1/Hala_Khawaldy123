...
let imagesArray = ['1.jpg', '2.jpg', '3.jpg', '4.jpg', '5.jpg', '6.jpg', '7.jpg', '8.jpg', '9.jpg', '10.jpg', '11.jpg', '12.jpg', '13.jpg', '14.jpg', '15.jpg'];
let chosenImgs = [];


function getRandomImage() {
  let randomIndex = Math.floor(Math.random() * imagesArray.length);
  let chosenImg = imagesArray[randomIndex];

  while (chosenImgs.includes(chosenImg)) {
    randomIndex = Math.floor(Math.random() * imagesArray.length);
    chosenImg = imagesArray[randomIndex];
  }
...
function showIncorrectImage() {
  ...
  let incorrectImageDiv = document.querySelector('.incorrect-answer-image');
    ...
    // טיימר להסתרת התמונה עם עיכוב לפני המשך
    setTimeout(() => {
   ...
   // עיכוב של 5 שניות להסתרת התמונה
  ...
  audio.play();
   ...
   start();
    if (rightAnswers > count / 2 && rightAnswers < count) {
      theResults = `<span class="good" style="display: flex; flex-direction:column; align-items: center;" > The result: ${rightAnswers} correct answers out of ${count} <hr/> <img src="gif1.gif" alt="Description">  </span> `;
    } else if (rightAnswers === count) {
      theResults = `<span class="perfect" style="display: flex; flex-direction:column; align-items: center;" > The result: ${rightAnswers} correct answers out of ${count} <hr/> <img src="gif1.gif" alt="Description">  </span> `
    } else {
